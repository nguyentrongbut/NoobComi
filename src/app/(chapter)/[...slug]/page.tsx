...
import FeatHover from "../@components/feat.hover";
...
const ChapterPage = async ({ params }: { params: { slug: string[] } }) => {
  ...
  return (
    <section className="mb-28 relative">
      <FeatHover data={res1} slugChapters={slugChapters}></FeatHover>
        ...
        {nextChapter?.content ? (
          <>
            <div className="max-w-screen-md mx-auto rounded-lg bg-white p-6 shadow-sm">
                  ...
                  <div className="flex flex-col w-full">
                    ...
                    <div className="mt-auto flex gap-2 sm:gap-4 text-sm mx-3 mb-1.5 sm:mb-3 justify-end">
                      ...
                      >
                        ...
                        <span>{nextChapter?.comments}</span>
                      </span>
                      <span
                        className="flex gap-1 items-center"
                        title={dayjs(nextChapter?.createdAt).fromNow()}
                      >
                        <IconOclock />
                        <span className="line-clamp-1">
                          {dayjs(nextChapter?.createdAt).fromNow()}
                        </span>
                      </span>
                    </div>
                  </div>
              ...
              <Link
                href={`/${params.slug[0]}/${covertSlugUrl(nextChapter.title)}-${
                  nextChapter.id
                }.html`}
              >
      ...
      <div className="wrapper mt-4">
        <div className="max-w-screen-md mx-auto rounded-lg bg-white p-6 shadow-sm">
          ...
          <p className="mt-2">
            If you enjoyed that chapter, be sure to let the creator know how you
            felt!
          </p>
